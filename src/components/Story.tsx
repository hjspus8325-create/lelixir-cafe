...
import { Droplet, Sun, Flame, Sparkles, CheckCircle2 } from "lucide-react";
...
export default function Story() {
  ...
  return (
    <section id="story" className="py-20 sm:py-24 bg-[#0c0b0a] relative overflow-hidden">
      {/* Ambient Glow */}
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12">
        ...
        {/* Tab Selection */}
        <div className="flex justify-center gap-2.5 sm:gap-4 mb-10 sm:mb-14 flex-wrap">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="glass-panel p-6 sm:p-10 rounded-3xl border-[#c5a059]/20 relative">
            ...
            <p className="text-sm sm:text-base text-[#e8dfd3] leading-relaxed mb-6 sm:mb-8 font-light">
          ...
          {/* Visual Card */}
          <div className="relative h-72 sm:h-[480px] rounded-3xl overflow-hidden glass-panel border-[#c5a059]/20 group">
            <Image
